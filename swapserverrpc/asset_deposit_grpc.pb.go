...
type AssetDepositServiceClient interface {
	...
	CoSignHtlc(ctx context.Context, in *CoSignHtlcReq, opts ...grpc.CallOption) (*CoSignHtlcRes, error)
}
...
func (c *assetDepositServiceClient) CoSignHtlc(ctx context.Context, in *CoSignHtlcReq, opts ...grpc.CallOption) (*CoSignHtlcRes, error) {
	out := new(CoSignHtlcRes)
	err := c.cc.Invoke(ctx, "/looprpc.AssetDepositService/CoSignHtlc", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AssetDepositServiceServer interface {
	...
	CoSignHtlc(context.Context, *CoSignHtlcReq) (*CoSignHtlcRes, error)
...
func (UnimplementedAssetDepositServiceServer) CoSignHtlc(context.Context, *CoSignHtlcReq) (*CoSignHtlcRes, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CoSignHtlc not implemented")
}
...
func _AssetDepositService_CoSignHtlc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CoSignHtlcReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AssetDepositServiceServer).CoSignHtlc(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/looprpc.AssetDepositService/CoSignHtlc",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AssetDepositServiceServer).CoSignHtlc(ctx, req.(*CoSignHtlcReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AssetDepositService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CoSignHtlc",
			Handler:    _AssetDepositService_CoSignHtlc_Handler,
		},
	},
