...
func NewOutFSM(ctx context.Context, cfg *FSMConfig) *OutFSM {
	out := &SwapOut{
		State: fsm.EmptyState,
	}

	return NewOutFSMFromSwap(ctx, cfg, out)
}

// NewOutFSMFromSwap creates a new OutFSM from a existing swap.
func NewOutFSMFromSwap(ctx context.Context, cfg *FSMConfig, swap *SwapOut,
) *OutFSM {
...
func (o *OutFSM) updateSwap(notification fsm.Notification) {
	...
	err := o.cfg.Store.InsertAssetSwapUpdate(
		o.runCtx, o.SwapOut.SwapHash, o.SwapOut.State,
	)
	if err != nil {
...
func (o *OutFSM) createPreimageWitness(ctx context.Context,
	...
	successScript, err := o.SwapOut.GetSuccesScript()
	if err != nil {
		return nil, err
	}
