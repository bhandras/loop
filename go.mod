...
require (
	...
	github.com/lightningnetwork/lnd/sqldb v1.0.0 // indirect
...
replace github.com/lightninglabs/taproot-assets => github.com/bhandras/taproot-assets v0.0.0-20240415204011-3c6c6b495206

replace github.com/lightningnetwork/lnd => github.com/lightningnetwork/lnd v0.17.0-beta.rc6.0.20240411224156-1c229e44227e

replace github.com/lightningnetwork/lnd/sqldb => github.com/lightningnetwork/lnd/sqldb v1.0.1

replace github.com/lightningnetwork/lnd/kvdb => github.com/lightningnetwork/lnd/kvdb v1.4.6-0.20240411130403-648fb22f63ea

replace github.com/lightninglabs/lndclient => github.com/lightninglabs/lndclient v0.17.4-3

replace go.etcd.io/etcd/client/v3 => go.etcd.io/etcd/client/v3 v3.5.7
