CREATE TABLE IF NOT EXISTS asset_deposits (
    ...
    -- server_pubkey is the server side public key that is used to construct
    -- the 2-of-2 MuSig2 anchor output that holds the deposited funds.
    ...
    -- timeout_sweep_addr is the address we'll use to sweep back the deposit to
    -- if it has timed out.
    timeout_sweep_addr TEXT
);
