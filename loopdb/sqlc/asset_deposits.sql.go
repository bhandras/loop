...
SELECT d.deposit_id, d.created_at, d.asset_id, d.amount, d.client_pubkey, d.server_pubkey, d.expiry, d.client_key_family, d.client_key_index, d.addr, d.protocol_version, d.confirmation_height, u.update_state, u.update_timestamp
...
func (q *Queries) MarkDepositConfirmed(ctx context.Context, arg MarkDepositConfirmedParams) error {
	_, err := q.db.ExecContext(ctx, markDepositConfirmed, arg.DepositID, arg.ConfirmationHeight)
	return err
}
