...
SELECT d.deposit_id, d.protocol_version, d.created_at, d.asset_id, d.amount, d.client_pubkey, d.server_pubkey, d.expiry, d.client_key_family, d.client_key_index, d.addr, d.confirmation_height, d.outpoint, d.pk_script, u.update_state, u.update_timestamp
