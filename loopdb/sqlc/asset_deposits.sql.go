...
SELECT d.deposit_id, d.protocol_version, d.created_at, d.asset_id, d.amount, d.client_script_pubkey, d.client_internal_pubkey, d.server_pubkey, d.expiry, d.client_key_family, d.client_key_index, d.addr, d.confirmation_height, d.outpoint, d.pk_script, d.timeout_sweep_addr, u.update_state, u.update_timestamp
...
const setAssetDepositTimeoutSweepAddr = `-- name: SetAssetDepositTimeoutSweepAddr :exec
UPDATE asset_deposits
SET timeout_sweep_addr = $2
WHERE deposit_id = $1
`

type SetAssetDepositTimeoutSweepAddrParams struct {
	DepositID        string
	TimeoutSweepAddr sql.NullString
}

func (q *Queries) SetAssetDepositTimeoutSweepAddr(ctx context.Context, arg SetAssetDepositTimeoutSweepAddrParams) error {
	_, err := q.db.ExecContext(ctx, setAssetDepositTimeoutSweepAddr, arg.DepositID, arg.TimeoutSweepAddr)
	return err
}
